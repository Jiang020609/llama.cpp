...
struct common_params_diffusion {
    ...
    bool    mbsd_lifecycle_bookkeeping = false; // observer-only token/cache lifecycle bookkeeping
    bool    mbsd_logical_kv = false;  // host-only stable/mutable/window logical KV ledger
